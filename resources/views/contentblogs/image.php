...
<section class="w3-padding">
   <h2>Content Blogs Icon</h2>

   <div class="w3-margin-bottom">
      <?php if($contentblog->image): ?>
         <img src="<?= asset('storage/'.$contentblog->image) ?>" width="100">
      <?php endif; ?>
   </div>

   <form method="post" action="/console/contentblogs/image/<?= $contentblog->id ?>" novalidate class="w3-margin-bottom" enctype="multipart/form-data">
         <?= csrf_field() ?>
      ...
      <a href="/console/contentblogs/list">Back to Content Blogs</a>
