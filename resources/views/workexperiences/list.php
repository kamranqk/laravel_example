...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section class="w3-padding">
            ...
            <h2>Manage WorkExperience Records</h2>
            ...
            <table class="w3-table w3-stripped w3-bordered w3-margin-bottom">
                ...
                <?php foreach($workexperiences as $workexperience): ?>
                    <tr>
                        ...
                        <td><a href="/console/workexperiences/edit/<?= $workexperience->id ?>">Edit</a></td>
                        <td><a href="/console/workexperiences/delete/<?= $workexperience->id ?>">Delete</a></td>
                    </tr>
                <?php endforeach; ?>
            </table>

            <a href="/console/workexperiences/add" class="w3-button w3-green">Add WorkExperience Record</a>
